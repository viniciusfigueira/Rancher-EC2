...
| [rancher2_cluster.workload](https://registry.terraform.io/providers/rancher/rancher2/1.23.0/docs/resources/cluster) | resource |
...
| Name | Description |
|------|-------------|
| <a name="output_custom_cluster_command"></a> [custom\_cluster\_command](#output\_custom\_cluster\_command) | Docker command used to add a node to the cluster |
| <a name="output_custom_cluster_windows_command"></a> [custom\_cluster\_windows\_command](#output\_custom\_cluster\_windows\_command) | Docker command used to add a windows node to the cluster |
